...
"""Advantage computation for GRPO / RLOO / REINFORCE++.

Pure tensor functions. No distributed communication or Trainer dependencies.
Replaces and extends ``swift.rlhf_trainers.utils.compute_grpo_advantages``.
"""
...
def compute_advantages(
    ...
    Args:
        ...
        kl_in_reward: Subtract KL penalty from rewards.
        beta: KL penalty coefficient.
        kl_values: ``[N]`` KL values (required when ``kl_in_reward=True``).
